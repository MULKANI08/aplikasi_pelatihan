            ...
            <ul id="sidebarnav">
				...
				<li> <a class="waves-effect waves-dark dropdown-toggle" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Laporan</span></a>
					<ul>
						...
						<li>
							<a class=" waves-effect waves-dark" href="<?php echo site_url('laporan/pendaftar_pelatihan')?>" aria-expanded="false"><i class="mdi mdi-checkbox-blank-circle"></i><span class=" p-2">Rekap Pendaftar Baru</span></a>
                		</li>
						<li>
							<a class=" waves-effect waves-dark" href="<?php echo site_url('laporan/status_pendaftar')?>" aria-expanded="false"><i class="mdi mdi-checkbox-blank-circle"></i><span class=" p-2">Rekap Status Pendaftar</span></a>
                		</li>
						<li>
							<a class=" waves-effect waves-dark" href="<?php echo site_url('laporan/peserta')?>" aria-expanded="false"><i class="mdi mdi-checkbox-blank-circle"></i><span class=" p-2">Rekap Pendaftar Diterima</span></a>
                		</li>
						
						<li>
							<a class=" waves-effect waves-dark" href="<?php echo site_url('laporan/alumni')?>" aria-expanded="false"><i class="mdi mdi-checkbox-blank-circle"></i><span class=" p-2">Rekap Data Alumni</span></a>
                		</li>
						<li>
							<a class=" waves-effect waves-dark" href="<?php echo site_url('laporan/nilai')?>" aria-expanded="false"><i class="mdi mdi-checkbox-blank-circle"></i><span class=" p-2">Rekap Nilai Peserta</span></a>
                		</li>

...
<h4><p align="center">LAPORAN DATA PENDAFTAR PELATIHAN YANG BELUM DI VERIFIKASI (<?php echo tgl_indo($_POST['tanggal1']); ?> Hingga <?php echo tgl_indo($_POST['tanggal2']); ?>)</p></h4>
<h4><p>Di Cetak pada
<?php
 $hari   = date('l');
